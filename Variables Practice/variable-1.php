...
$age = 20; // Example of integer 

//This is Float 

$currency = 40.5; //Example of float like money in US ($40.5)
...
echo"My name is {$name} I'm {$age} years old <br> my Money is  $/{$currency} and im {$online} now ";
?>